...
>[RubyMine](https://www.jetbrains.com/rider/) originates from other JetBrains such as ReSharper and WebStorm but now turned into an IDE. It is cross-platform, meaning, it can run on both Windows, Mac and several flavors of Linux, offering the same set of functionality and identical behavior on all of them.

#### Rider Learning Resources
1. [Rider for #UnrealEngine public preview demo](https://www.youtube.com/watch?v=e6pVSyrQ3JE&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=2&t=0s)
2. [Nuke — Designing a Build System with IDE Support in Mind](https://www.youtube.com/watch?v=N57Zjb5-08I&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=2)
3. [Work With Entity Framework 6 Migrations In Rider](https://www.youtube.com/watch?v=-1mA7EU5aPw&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=3)
4. [Purging the Technical Debt by Using Static Code Analysis Tools](https://www.youtube.com/watch?v=_qMeJQ9Rzso&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=4)
5. [Background Tasks Without a Separate Service: Hangfire for ASP.NET](https://www.youtube.com/watch?v=bwBEYxePENk&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=5)
6. [Unity Development with Rider](https://www.youtube.com/watch?v=h564F6pLOsE&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=6)
7. [Introducing the AWS Toolkit for Rider](https://www.youtube.com/watch?v=EcI4qUsentY&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=7)
8. [Building an ASP.NET Core App from Start to Finish](https://www.youtube.com/watch?v=l2wE6KQuYRc&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=8)
9. [React + TypeScript + TDD in Rider](https://www.youtube.com/watch?v=p7QwwzP-et4&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=9)
10. [Better Xamarin Development with Rider for Mac](https://www.youtube.com/watch?v=sr48IF3Yp-s&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=10)
11. [TDD and The Terminator - An Introduction to Test Driven Development](https://www.youtube.com/watch?v=EcoIjf3RABI&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=11)
12. [From F# to JavaScript with Fable](https://www.youtube.com/watch?v=5191ytFmG_A&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=12)
13. [Cross-Platform .NET Development in Rider](https://www.youtube.com/watch?v=yD4i_fyNU6M&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=14)
14. [A Deep Dive into the .NET Client for Elasticsearch Codebase](https://www.youtube.com/watch?v=GBwuWbhv8Dc&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=15)
15. [Be More Productive with JetBrains Rider](https://www.youtube.com/watch?v=mTW_BUUKKRM&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=16)
16. [Building a Fantasy Game Console with C#, MonoGame, and Rider](https://www.youtube.com/watch?v=Xmfj3X23x7c&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=17)
17. [Refactor Now or Never](https://www.youtube.com/watch?v=081mxNOohbg&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=18)
18. [Debugging Tips & Tricks in Rider](https://www.youtube.com/watch?v=uALiyRpnovc&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=20)
19. [JetBrains Rider for Unity Development](https://www.youtube.com/watch?v=N7bHiFKC_uQ&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=21)
20. [Introducing Rider, The New .NET IDE From JetBrains](https://www.youtube.com/watch?v=v51ljZ39AHA&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=23)
21. [JetBrains Rider - New Cross-Platform .NET IDE Overview](https://www.youtube.com/watch?v=xkPtX492IhI&list=PLQ176FUIyIUbcAs90otEqyYImDGdisF9u&index=22)
...
>[Upsource](https://www.jetbrains.com/upsource/) is a smart code review tool and a repository browser that supports Git, Mercurial, Subversion and Perforce. It is the only code review tool that deeply understands your code and offers static code analysis and code-aware navigation in web UI for projects written in Java, PHP, JavaScript and/or Kotlin.

#### Upsource Learning Resources
1. [Code Review Best Practices](https://www.youtube.com/watch?v=a9_0UUUNt-Y&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=2&t=1s)
2. [Upsource Overview](https://www.youtube.com/watch?v=lS7E_Vbh9wQ&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=3)
3. [PHP code insight in Upsource](https://www.youtube.com/watch?v=KaRhE3I9YCs&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=5)
4. [Code Review with Upsource at Tallink](https://www.youtube.com/watch?v=YcHDsMgwKq0&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=7)
5. [Code review workflow in Upsource](https://www.youtube.com/watch?v=BCz5iFz9t3E&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=12)
6. [Upsource plugin for JetBrains IDEs](https://www.youtube.com/watch?v=NLnuWTYeCXk&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=13)
7. [Advanced Java support in JetBrains Upsource](https://www.youtube.com/watch?v=zD_ZqUEJep0&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=15)
8. [Code review with JetBrains Upsource](https://www.youtube.com/watch?v=5GqUe_7UFCo&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=16)
9. [Browsing repositories with JetBrains Upsource](https://www.youtube.com/watch?v=gWhuLeQ6fY4&list=PLQ176FUIyIUbYML7jekC3U5LXFf-quFqf&index=17)
...
[![Faceboom](https://img.shields.io/static/v1.svg?label=connect&message=@CodeOpsTech&color=grey&logo=facebook&style=flat&logoColor=white&colorA=royalblue)]
(https://www.facebook.com/CodeOpsTech)
